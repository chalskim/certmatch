...
import { IsUUID, IsString, IsOptional, Length, IsInt, Min, IsNumber, IsArray } from 'class-validator';
...
export class CreateExpertDto {
  ...
  @ApiProperty({ description: 'Expert biography', example: 'Experienced consultant in ISMS and ISO27001', required: false })
  @IsOptional()
  @IsString()
  bio?: string;

  @ApiProperty({ description: 'Specialty (JSON or string)', example: '{"areas": ["ISMS-P", "ISO27001"]}', required: false })
  @IsOptional()
  @IsString()
  specialty?: string;
  ...
  @ApiProperty({ description: 'Availability as JSON or string', example: '{"monday": "9-17"}', required: false })
  @IsOptional()
  @IsString()
  availability?: string;
}
...
export class ExpertResponseDto {
  ...
  @ApiProperty({ description: 'Specialty (JSON as string)', example: '{"areas": ["ISMS-P", "ISO27001"]}' })
  specialty: string;

  @ApiProperty({ description: 'Years of experience', example: 5 })
  experienceYears: number;

  @ApiProperty({ description: 'Expert biography', example: 'Experienced consultant in ISMS and ISO27001' })
  bio: string;

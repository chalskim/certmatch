...
import { styles } from '../styles/menu/PersonalRegistration';

export const PersonalRegistration: React.FC = () => {
  ...
  const availableCountries = ['미국', '일본', '중국', '싱가포르', '홍콩', '영국', '독일', '캐나다', '호주', '인도네시아', '태국', '베트남', '말레이시아', '뉴질랜드'];
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        ...
        <View style={styles.progressSteps}>
          ...
          <View style={styles.progressStep}>
            ...
            <Text style={styles.stepLabel}>전문 분야</Text>
          </View>
          <View style={styles.progressStep}>
            <View style={styles.stepCircle}>
              <Text style={styles.stepText}>3</Text>
            </View>
            <Text style={styles.stepLabel}>경력 및 자격</Text>
          </View>
          <View style={styles.progressStep}>
            <View style={styles.stepCircle}>
      ...
      <View style={styles.formContainer}>
        <View style={styles.formHeader}>
          <Text style={styles.formTitle}>개인 자격 등록</Text>
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.countryGroup}>
            <Text style={styles.countryLabel}>해외 경험 국가</Text>
            <View style={styles.countryContainer}>
              {availableCountries.map((country, index) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.countryTag,
                    selectedCountries.includes(country) && styles.countryTagSelected
                  ]}
                  onPress={() => toggleCountry(country)}
                >
                  <FontAwesome5 name="flag" size={12} color={selectedCountries.includes(country) ? '#fff' : '#666'} />
                  <Text style={[
                    styles.countryTagText,
                    selectedCountries.includes(country) && styles.countryTagTextSelected
                  ]}>
                    {country}
                  </Text>
                </TouchableOpacity>
            ...
            <Text style={styles.helpText}>해외 프로젝트 경험이 있는 국가를 선택해주세요. 다중 선택이 가능합니다.</Text>
          </View>
        </View>

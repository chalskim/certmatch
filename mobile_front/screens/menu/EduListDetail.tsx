...
const EduListDetail: React.FC = () => {
  ...
  const header = useMemo(
    () => ({
      ...
      rating: 4.8,
      ratingCount: 156,
      hero: 'https://picsum.photos/seed/isms-course/1200/300.jpg',
    }),
    []
  );
  ...
  const instructors = [
    {
      ...
      avatar: 'https://picsum.photos/seed/instructor1/150/150.jpg',
    ...
    },
    {
      ...
      avatar: 'https://picsum.photos/seed/instructor2/150/150.jpg',
    ...
    },
    {
      ...
      avatar: 'https://picsum.photos/seed/instructor3/150/150.jpg',
  ...
  return (
    <View style={styles.root}>
      ...
      <ScrollView style={styles.container}>
              ...
              <View style={styles.courseTitleInfo}>
                ...
                <View style={styles.actionsRow}>
                  ...
                  <TouchableOpacity style={styles.btnSecondary} onPress={() => {}}>
                    <FontAwesome5 name="share-alt" size={18} color={colors.muted} style={styles.btnIcon} />
        ...
        {/* 히어로 이미지 */}
        <Image source={{ uri: header.hero }} style={styles.heroImage as ImageStyle} />
              ...
              {modules.map((m, idx) => (
                <View key={`module-${idx}`} style={styles.module}>
                  <TouchableOpacity style={styles.moduleHeader} onPress={() => toggleModule(idx + 1)}>
                    ...
                    <FontAwesome5 name={expanded[idx + 1] ? 'chevron-down' : 'chevron-right'} size={16} color={colors.muted} />
                  </TouchableOpacity>
                  {expanded[idx + 1] && (
          ...
          <View style={styles.sectionCard}>
            ...
            {instructors.map((ins, i) => (
              <View key={`ins-${i}`} style={styles.instructorCard}>
                <Image source={{ uri: ins.avatar }} style={styles.instructorAvatar as ImageStyle} />
